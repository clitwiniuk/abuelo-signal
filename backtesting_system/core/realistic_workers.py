...
# Factory function to get realistic workers
def get_realistic_worker(worker_name: str) -> BaseRealisticWorker:
    """Factory function to create realistic workers"""
    ...
    workers = {
        ...
        'momentum_breakout': lambda name: MomentumBreakoutRealisticWorker(name),
        'bull_flag': lambda name: BullFlagRealisticWorker(name),
        'gap_go': lambda name: GapGoRealisticWorker(name)
    }
