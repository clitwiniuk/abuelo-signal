...
class UnifiedPositionManager:
    ...
    def __init__(self, total_capital: float = 2000.0, config: Dict = None):
        ...
        self._strategy_mapping = {
            ...
            'holy_grail': 'day',
            'vcp_strict_long': 'day',
            'vcp_strict_short': 'day',
            'smallcap_vwap_runner': 'day',
            # Swing trading workers
            'ods_swing_universal': 'swing',
            'swing_consolidation': 'swing',
            'swing_momentum': 'swing',
            # Short strategies (day trading - intraday only, no overnight)
            'short_parabolic': 'day',
            'gap_fade': 'day',
            'livermore_intraday': 'day',
            'livermore_intraday_worker_logic': 'day',
        ...
        self._worker_display_names = {
            ...
            'daily_plays_midcap': 'Daily Plays Midcap',
            'bull_flag': 'Bull Flag',
            ...
            'parabolic': 'Parabolic',
            'catalyst_dna': 'Catalyst DNA',
            'holy_grail': 'Holy Grail',
            'vcp_strict_long': 'VCP Strict Long',
            'vcp_strict_short': 'VCP Strict Short',
            'smallcap_vwap_runner': 'SC-VWAP-Run',
            'ods_swing_universal': 'ODS-Swing',
            'swing_consolidation': 'Swing-Cons',
            'swing_momentum': 'Swing-Mom',
            'short_parabolic': 'Short-Parabolic',
            'gap_fade': 'Gap-Fade',
            'livermore_intraday': 'Livermore',
            'smallcaps_short_reversal': 'SC-Short-Rev',
        }
