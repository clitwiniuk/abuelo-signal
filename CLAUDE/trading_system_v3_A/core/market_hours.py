...
def is_regular_hours() -> bool:
    ...
    return get_market_hours().is_regular_hours()


def can_enter_short() -> Tuple[bool, str]:
    """Quick check if SHORT entry is allowed"""
    return get_market_hours().can_enter_short()


def should_force_exit_short() -> Tuple[bool, str]:
    """Quick check if SHORT positions should be force-closed"""
    return get_market_hours().should_force_exit_short()


def get_market_session() -> str:
    """Quick check of current market session"""
    return get_market_hours().get_market_session()
