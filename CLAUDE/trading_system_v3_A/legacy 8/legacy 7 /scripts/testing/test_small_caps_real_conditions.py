...
class SmallCapsRealConditionsTest:
    ...
    def test_catalyst_news_scenarios(self):
        """Test reaction to various catalyst news scenarios"""
        print("\n📰 TESTING CATALYST NEWS SCENARIOS")
        print("=" * 70)
        
        scenarios = [
            {
                'name': "FDA Approval (Strong)",
                'news': [
                    {
                ...
                'price_action': {'gap': 25.0, 'volume': 500000},
                'expected_decision': True,
                'expected_type': 'CATALYST_NEWS'
            },
            {
