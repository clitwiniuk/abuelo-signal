...
class Order:
    ...
    # Extended hours support - Time In Force (TIF)
    tif: Optional[str] = None  # "DAY", "GTC", "GTD", etc.
...
class TradingConfig:
    ...
    portfolio_capital: float = 3000.0
...
# Import new Broker Adapter interfaces exposed by this package
from .broker_adapter import AbstractBroker, BrokerOrder, BrokerPosition
