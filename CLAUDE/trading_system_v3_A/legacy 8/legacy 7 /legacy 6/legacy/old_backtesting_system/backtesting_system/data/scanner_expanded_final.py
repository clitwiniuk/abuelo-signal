#!/usr/bin/env python3
"""
Scanner Expanded Downloader - VERSIÓN CORRECTA
Lee oportunidades reales del scanner y las descarga con event_id + contexto histórico
"""
...
class ScannerExpandedDownloader:
    ...
    def download_contextual_history(self, symbol: str, event_date: datetime, event_id: int, days_history: int = 3) -> int:
...
def main():
    ...
    print("Lee oportunidades reales del scanner y las descarga con event_id + contexto")
    print("=" * 70)
    ...
    print(f"\n🎯 Descargando TODAS las oportunidades del scanner...")
    stats = downloader.download_opportunities_expanded(limit=None)
