...
# Predefined Events
def create_bar_event(bar_data: 'MarketData', clock: TimeProvider = None) -> Event:
    """Create a bar received event"""
    timestamp = clock.now() if clock else datetime.now()
    return Event(
        event_id="",
...
def create_signal_event(signal: 'Signal', clock: TimeProvider = None) -> Event:
...
def create_order_event(order: 'Order', event_type: str, clock: TimeProvider = None) -> Event:
...
def create_position_event(position: 'Position', event_type: str, clock: TimeProvider = None) -> Event:
...
def create_error_event(error: Exception, component: str, clock: TimeProvider = None) -> Event:
