...
class IBKRNativeScanner:
    ...
    def _get_scanner_configurations(self) -> List[Dict[str, Any]]:
        ...
        """
        return [
            # DISABLED: GAP_UP scanner causes hanging when disabled by IBKR
            # {
            #     'name': 'gap_up_movers',
            #     'scan_code': 'GAP_UP',  # DISABLED: Scanner disabled by IBKR
            #     'instrument': 'STK',
            #     'location_code': self.exchange_filter,
            #     'stock_type': 'ALL',
            #     'above_price': 0.5,      # Above $0.50
            #     'below_price': 15.0,     # Below $15 (smallcap range)
            #     'above_volume': 500000,  # Min volume 500K
            #     'market_cap_below': 2000,  # Below $2B market cap
            ...
            # DISABLED: GAP_UP premarket scanner causes hanging
            # {
            #     'name': 'premarket_gaps',
            #     'scan_code': 'GAP_UP',  # DISABLED: Scanner disabled by IBKR
            #     'instrument': 'STK',
            ...
            #     'exclude_convertible': True
            # },
            # DISABLED: GAP_DOWN scanner causes hanging
            # {
            #     'name': 'gap_down_movers',
            #     'scan_code': 'GAP_DOWN',  # DISABLED: Scanner disabled by IBKR
            #     'instrument': 'STK',
            #     'location_code': self.exchange_filter,
            #     'stock_type': 'ALL',
            #     'above_price': 0.5,
