#!/usr/bin/env python3
"""
Simulate Momentum Breakout Strategy P&L with REAL DATA (Adaptive Thresholds)

This script uses the updated worker with adaptive thresholds.
"""
...
async def main():
    ...
    print("\n" + "="*80)
    print("🚀 MOMENTUM BREAKOUT STRATEGY SIMULATION - ADAPTIVE THRESHOLDS")
    print("="*80)
