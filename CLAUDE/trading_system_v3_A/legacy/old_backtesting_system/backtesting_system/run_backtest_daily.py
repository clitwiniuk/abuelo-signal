#!/usr/bin/env python3
"""
Script para Ejecutar Backtests DAILY

Ejecuta backtests usando datos diarios desde tabla trade_ohlc_snapshots
...
def main():
    """Función principal"""
    print("🚀 Iniciando Sistema de Backtesting DAILY")
    print("=" * 60)
    ...
    try:
        ...
        # Símbolos con datos diarios disponibles
        symbols = ['LAES', 'HIVE', 'NUAI', 'CYN', 'SEED', 'PFAI', 'REKR']
        print(f"📈 Cargando datos DAILY para: {symbols}")

        # IMPORTANTE: Cargar datos con data_type='daily'
        engine.load_data(symbols, data_type='daily')

        # Ejecutar backtest
        print("⚡ Ejecutando backtest DAILY...")
        ...
        print("\n" + "=" * 60)
        print("📋 RESULTADOS DEL BACKTEST DAILY")
        print("=" * 60)
        ...
        print("✅ Backtest DAILY completado exitosamente!")
        ...
        print(f"❌ Error durante el backtest DAILY: {e}")
