    ...
    def save_trade(self, trade_data: Dict[str, Any]) -> bool:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                if existing:
                    # Update existing trade (including order flow fields, analytics, and adaptive risk fields)
                    conn.execute("""
                        UPDATE trades SET
                    ...
                    """, (
                        ...
                        # Adaptive Risk Analytics fields (NEW)
                    ...
                    # Insert new trade (including order flow fields, analytics, and adaptive risk fields)
                    conn.execute("""
                        INSERT INTO trades (
