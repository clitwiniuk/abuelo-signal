...
class ConfigManager:
    ...
    VALIDATION_RULES = {
        'GLOBAL': {
            ...
            'max_positions': ConfigRule(required=True, type=ConfigType.INT, min_value=1, max_value=100),
        },
        'TRADING': {
            'max_daily_trades': ConfigRule(required=True, type=ConfigType.INT, min_value=1, max_value=200),
            'max_daily_loss': ConfigRule(required=True, type=ConfigType.FLOAT, min_value=-10000.0, max_value=0.0),
        ...
        'IBKR': {
            ...
            'port': ConfigRule(required=True, type=ConfigType.INT, min_value=4000, max_value=5000),
